...
//include_once ('inc/activaerror.php');
	...
	$Cdp = new ODBC_Conn("NINGRESO","sysadm","sysadm",$ODBCC_conBitacora, $laBitacora);
	...
	$mSQL = $mSQL."where ci_e='".$cedula."' and a.c_uni_ca=b.c_uni_ca AND apellidos||' '||apellidos2 LIKE '%".strtoupper($contra)."%' ";
...
//	print $du[0];
	...
	if (count($dp) == 0) {
		echo '<script languaje=\"javacript\">alert("Para poder consultar su planilla debe formalizar su inscripcion en la Unidad Regional de Control de Estudios (URACE).");window.close();</script>';
	}
...
Fecha:&nbsp; <? echo $fecha  = date('d/m/Y', time() - 3600*date('I'))?>&nbsp;&nbsp;Hora: &nbsp; <? echo $hora   = date('h:i:s A', time() - 3600*date('I'))?> </td></tr>   
            <tr><td class="dp">&nbsp;</td><tr> 
 	   </table>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="dp"><?echo $dp[0]." ".$dp[5]?></div></td>

                    <td bgcolor="#FFFFFF">
                       <div class="dp"><?echo $dp[1]." ".$dp[6]?></div></td>
                    <td bgcolor="#FFFFFF">
                       <div class="dp"><?echo $dp[2]?></div></td>
                    <td style="width: 114px;" bgcolor="#FFFFFF">
                       <div class="dp"><?echo $dp[3]?></div></td>
                </tr>
    ...
    <td width="750">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 570px;" bgcolor="#FFFFFF">
                        <div class="dp">Especialidad: <?echo $dp[4]?> </div></td>
                </tr>
            </tbody>
        </table>
    </td>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550">
			...
			<?php
			//print_r($datosp);
				$Cmat = new ODBC_Conn("NINGRESO","c","c",$ODBCC_conBitacora, $laBitacora);
...
?>
		...
		<tr><td>
			<TABLE align="center" border="0" cellpadding="3" cellspacing="1" width="550"
				style="border-collapse: collapse;">
			<tr><td colspan="1" style="text-align:left;font-weight:bold;font-family:Arial;font-size:10pt;padding-left:0px;">
				<br><br>
				Jornada de Inducci&oacute;n: Mi&eacute;rcoles 14 y Jueves 15 de Octubre de 2015 a las 8:30 am.<br>
				Jornada para Padres y Representantes: 15 de Octubre de 2015 a las 2:00 pm.<br>
				Lugar: Auditorio Osvaldo Silva UNEXPO<br><br>
				Incio del Lapso Acad&eacute;mico <?php echo $lapsoProceso; ?>: 19 de Octubre de 2015.
			</td></tr>
			</table>
		</td></tr>
		...
		?>
		  ...
		  <tr  class="dp1">
			<td width="800px"><BR><BR><BR><BR><BR><BR><BR><BR><BR>_____________________________________</td>
			<td><BR><BR><BR><BR><BR><BR><BR><BR><BR>_____________________________________</td>
		  </tr>
		  <tr class="dp1">
